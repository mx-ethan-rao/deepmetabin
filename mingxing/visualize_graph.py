...
def plot_graph(root_path, csv_path, output_path="/home/eddie/cami1-low-log"):
...
def create_knn_graph(data_list):
...
def construct_knn_graph(data_list, plotting_graph_size, plotting_contig_list, k=3):
...
if __name__ == "__main__":
    ...
    plot_graph(root_path, csv_gmvae_path)
